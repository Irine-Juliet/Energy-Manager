...
from energy_tracker.forms import ActivityForm, SettingsForm, SignUpForm
...
class TestActivityForm:
    ...
    @pytest.mark.parametrize(
        "hours,minutes,expected_duration",
        [
            (2, 30, 150),
            (0, 15, 15),
            (1, 0, 60),
    ...
    def test_minimum_duration_validation(self):
        ...
        assert (
            ...
            or "duration_hours" in form.errors
            or "duration_minutes" in form.errors
        )
...
class TestSignUpForm:
    ...
    def test_username_already_exists(self):
        ...
        User.objects.create_user(
            username="existinguser", email="existing@example.com", password="testpass"
        )
