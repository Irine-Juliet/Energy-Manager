...
class TestActivityModel:
    ...
    def test_activity_default_values(self, user):
        ...
        activity = Activity.objects.create(user=user, name="Quick Task", energy_level=2)
    ...
    def test_energy_level_choices_valid(self, user, energy_level):
        ...
        activity = Activity.objects.create(
            user=user, name="Test Activity", energy_level=energy_level, duration=30
        )
    ...
    def test_energy_level_invalid_zero(self, user):
        ...
        activity = Activity(
            user=user, name="Test Activity", energy_level=0, duration=30
        )
    ...
    def test_energy_level_out_of_range(self, user, invalid_level):
        ...
        activity = Activity(
            user=user, name="Test Activity", energy_level=invalid_level, duration=30
        )
    ...
    def test_duration_validation_minimum(self, user):
        ...
        activity_valid = Activity(
            user=user, name="Quick Task", energy_level=1, duration=1
        )
        activity_valid.full_clean()  # Should not raise

        # Invalid: duration = 0
        activity_zero = Activity(
            user=user, name="Zero Duration", energy_level=1, duration=0
        )
        with pytest.raises(ValidationError):
        ...
        activity_negative = Activity(
            user=user, name="Negative Duration", energy_level=1, duration=-5
        )
        with pytest.raises(ValidationError):
    ...
    def test_duration_validation_maximum(self, user):
        ...
        activity_valid = Activity(
            user=user, name="All Day Task", energy_level=1, duration=1440
        )
        activity_valid.full_clean()  # Should not raise

        # Invalid: duration = 1441
        activity_over = Activity(
            user=user, name="Over Max", energy_level=1, duration=1441
        )
        with pytest.raises(ValidationError):
        ...
        activity_way_over = Activity(
            user=user, name="Way Over Max", energy_level=1, duration=10000
        )
        with pytest.raises(ValidationError):
    ...
    def test_activity_ordering(self, user):
        ...
        activity3 = Activity.objects.create(
            user=user, name="Third", energy_level=1, activity_date=now
        )
    ...
    def test_str_method(self, user):
        ...
        activity = Activity.objects.create(
            user=user, name="Team Meeting", energy_level=1, duration=90
        )
    ...
    def test_get_duration_display(self, user, duration, expected):
        ...
        activity = Activity.objects.create(
            user=user, name="Test", energy_level=1, duration=duration
        )

        assert activity.get_duration_display() == expected

    @pytest.mark.parametrize(
        "energy_level,expected_emoji",
        [
            (-2, "😫"),
            (-1, "😔"),
            (1, "😊"),
    ...
    def test_get_energy_emoji(self, user, energy_level, expected_emoji):
        ...
        activity = Activity.objects.create(
            user=user, name="Test", energy_level=energy_level, duration=30
        )
    ...
    def test_activity_user_relationship(self, user):
        ...
        activity = Activity.objects.create(
            user=user, name="Test", energy_level=1, duration=30
        )
    ...
    def test_activity_description_optional(self, user):
        ...
        activity1 = Activity.objects.create(
            user=user, name="No Description", energy_level=1, duration=30
        )
...
class TestUserProfileModel:
    ...
    def test_default_theme_value(self, db):
        ...
        user = User.objects.create_user(
            username="themetest", email="theme@example.com", password="testpass"
        )
    ...
    def test_default_notifications_value(self, db):
        ...
        user = User.objects.create_user(
            username="notiftest", email="notif@example.com", password="testpass"
        )
