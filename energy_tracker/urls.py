...
urlpatterns = [
    ...
    path(
        ...
        views.autocomplete_activities_view,
        name="autocomplete_activities",
    ),
    ...
    path(
        "activity/<int:pk>/delete/", views.delete_activity_view, name="delete_activity"
    ),
    path(
        "activities/bulk-delete/",
        views.bulk_delete_activities_view,
